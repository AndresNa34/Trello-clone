...
export class BtnComponent {
  ...
  //una funcion get se ejecuta de forma automatica
  get colors() {
    return{
      'text-white': this.color === 'success' || this.color === 'sky' || this.color === 'red',
      'text-gray-700': this.color === 'gray-light',
      'bg-success-700': this.color === 'success',
      'hover:bg-success-800': this.color === 'success',
      'focus:ring-success-300': this.color === 'success',
      'bg-primary-700': this.color === 'sky',
      'hover:bg-primary-800': this.color === 'sky',
      'focus:ring-primary-300': this.color === 'sky',
